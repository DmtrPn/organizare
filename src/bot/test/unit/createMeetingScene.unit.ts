...
import { MeetingCreateScene } from '@bot/scenes/MeetingCreateScene';

/*
Пользователь: /create_meeting
Бот: "Введите название встречи."
...
Edit
Пользователь: /edit_meeting
Бот: "Выберите встречу для редактирования:"
    [Кнопки с предстоящими встречами]

(Пользователь выбирает встречу)
Бот: "Что вы хотите изменить?"
    [Кнопки: Название, Дата/Время, Участники]

(Пользователь выбирает «Дата/Время»)
Бот: "Выберите новую дату и время:"
    [Кнопки с предложенными вариантами]

(Пользователь выбирает дату)
Бот: "Изменения сохранены. Новая встреча: Командное собрание на 12 декабря в 14:00."
 */
